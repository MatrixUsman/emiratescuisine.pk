...
export default function Footer() {
  return (
    <footer className="bg-dark-surface border-t border-dark-border">
      <div className="container mx-auto px-safe py-12 sm:py-14 md:py-16">
        ...
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:grid-cols-4">
          {/* About */}
          <div className="flex flex-col">
            <h3 className="mb-4 font-display text-base sm:text-lg md:text-xl font-bold text-primary">
              Emirates Cuisine
            </h3>
            <p className="mb-6 text-xs sm:text-sm text-dark-muted leading-relaxed">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              ...
              >
                <svg className="h-4 w-4 sm:h-5 sm:w-5 transition-transform duration-500 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-4 text-xs sm:text-sm">
              {branches.map((branch) => (
                <li key={branch.id} className="flex items-start gap-3">
                  <MapPin className="mt-0.5 h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 text-primary" />
        ...
        {/* Footer Bottom */}
        <div className="mt-12 sm:mt-14 md:mt-16 border-t border-dark-border pt-6 sm:pt-8 text-center text-xs sm:text-sm text-dark-muted">
          <p>
